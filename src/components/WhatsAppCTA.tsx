export default function WhatsAppCTA() {
    ...
    return (
        ...
        >
            ...
            {/* Tooltip */}
            <div className="absolute right-16 top-1/2 -translate-y-1/2 bg-white text-text text-xs font-medium px-4 py-2 rounded-lg shadow-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
